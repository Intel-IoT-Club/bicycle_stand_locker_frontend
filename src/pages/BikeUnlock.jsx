          ...
          <div className="flex-1 overflow-auto px-6">
              ...
              <div className="flex ">
                <div className="flex-col flex-1 flex">
                  <div className="bg-[#016766] text-white flex justify-center text-3xl border cursor-pointer"
                  ...
                  {sortstate.show && (
                    ...
                    <div className="px-3 ">
                      {SORT_LABELS.map((label,idx)=>{
                        return <div className={`mt-2 flex justify-between cursor-pointer border-1 p-1
                  ...
                  <div className="flex-1">
                    <div className="bg-[#016766] text-white flex flex-1 justify-center text-3xl border cursor-pointer"
