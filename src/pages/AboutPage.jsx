...
const AboutPage = () => {
  return (
    <>
    <Header/>
    <div className="bg-[#F9F8E9] font-afacad h-auto m-0">
      {/* Header */}
      <div className="bg-gradient-to-b from-[#024A48] via-[#082323] to-[#101010] text-center py-6">
        <h2 className="text-5xl font-bold text-white">About Us</h2>
      </div>

      {/* Content */}
      <div className="flex-1 w-full px-24 py-24 grid grid-cols-1 lg:grid-cols-2 items-center">
        {/* Left Section */}
        <div className="flex flex-col justify-center items-center text-center gap-y-8 px-24 py-12">
          <h3 className="font-bold text-6xl">
            Connecting Our Campus, Faster
          </h3>
          <p className="font-normal text-3xl">
            We are a team of innovators from the IoT Club dedicated to building a
            smart, sustainable future. Our Bicycle Rental Project leverages IoT and
            cloud technology to make commuting convenient, secure, and eco-friendly
            by reducing manual effort and providing a seamless user experience.
          </p>
        </div>
